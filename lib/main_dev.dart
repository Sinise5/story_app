...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              StoryListScreen(isPaid: flavor == 'Free' ? 'Free' : 'Paid'),
        ),
        GoRoute(
          path: '/addStory',
          builder: (context, state) =>
              AddStoryScreen(isPaid: flavor == 'Free' ? 'Free' : 'Paid'),
        ),
        GoRoute(
          path: '/settings',
    ...
    return MaterialApp.router(
      ...
      title: flavor == 'Free' ? 'Story App Free' : 'Story App Paid',
